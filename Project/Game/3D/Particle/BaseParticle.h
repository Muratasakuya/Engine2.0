...
public:
	...
	// Setter
	virtual void SetName(const std::string& name = "particle") override;
...
template<ParticleType particleType>
inline void BaseParticle<particleType>::Draw(BlendMode blendMode) {

	particleSystem_->Draw(IBaseParticle::GetName(), blendMode);
...
template<ParticleType particleType>
inline void BaseParticle<particleType>::SetName(const std::string& name) {

	IBaseParticle::SetName(name);
}